...
def index(request):
    ...
    num_books_kniga = Book.objects.filter(title__icontains='kniga').count()
    ...
    return render(
        request,
        'index.html',
        context={'num_books_kniga': num_books_kniga, 'num_genres': num_genres, 'num_books': num_books,
...
class AuthorListView(generic.ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['phraze'] = 'Happy to present you our talents!'
        return context
